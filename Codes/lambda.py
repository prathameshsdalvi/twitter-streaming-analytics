# Lambda function that copies data from DynamoDB to ES
# This is triggered when new data is added to the DynamoDB table
import base64
import datetime
import json
import logging
...
ES_ENDPOINT = 'search-your-es-endpoint-xxxxxxxxxxxxxxxxxxxxxxxxxx.us-east-1.es.amazonaws.com/'
